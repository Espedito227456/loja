...
//
	...
	private void carregarComboBox(ComboBox<String> comboBox, String coluna) {
		...
		try (Connection conn = ClasseConexao.conectar()){
			//Faz o select na coluna e joga na variavel results rs
			...
			//Preenche a Combobox com os dados puxados do banco
			comboBox.setItems(lista);
			//Execução caso tenha puxado algo errado.
		}catch(Exception e) {
			e.printStackTrace();
		}
	}
